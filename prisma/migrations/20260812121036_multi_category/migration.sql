...
INSERT INTO "new_User" ("createdAt", "email", "id", "isAdmin", "name", "passwordHash", "uniformNumber", "updatedAt") SELECT "createdAt", "email", "id", "isAdmin", "name", "passwordHash", "uniformNumber", "updatedAt" FROM "User";
DROP TABLE "User";
